  ...
  <div class="bottom-bar">
    <div class="bottom-bar__items" horizontal-center>
      ...
      <div
        :class="{
          item: true,
          'item--active': activeMenu === menuConstants.SETTINGS.path,
        }"
        horizontal-center
        @click="click(menuConstants.SETTINGS)"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
          <path opacity="0.2" d="M12 2C12.69 2 13.36 2.07 14 2.21V5.05C14 5.57 14.42 5.99 14.94 5.99H17.79C17.93 6.63 18 7.31 18 8C18 8.69 17.93 9.36 17.79 10H14.94C14.42 10 14 10.42 14 10.94V13.79C13.36 13.93 12.69 14 12 14C11.31 14 10.64 13.93 10 13.79V10.94C10 10.42 9.58 10 9.06 10H6.21C6.07 9.36 6 8.69 6 8C6 7.31 6.07 6.64 6.21 5.99H9.06C9.58 5.99 10 5.57 10 5.05V2.21C10.64 2.07 11.31 2 12 2Z" fill="#273251"/>
          <path d="M19.43 12.98C19.47 12.66 19.5 12.34 19.5 12C19.5 11.66 19.47 11.34 19.43 11.02L21.54 9.37C21.72 9.23 21.77 8.97 21.68 8.76L19.68 5.24C19.58 5.04 19.36 4.95 19.15 5.01L16.65 5.79C16.13 5.4 15.56 5.08 14.94 4.86L14.5 2.25C14.46 2.03 14.27 1.88 14.05 1.88H9.95C9.73 1.88 9.54 2.03 9.5 2.25L9.06 4.86C8.44 5.08 7.87 5.4 7.35 5.79L4.85 5.01C4.64 4.95 4.42 5.04 4.32 5.24L2.32 8.76C2.23 8.97 2.28 9.23 2.46 9.37L4.57 11.02C4.53 11.34 4.5 11.66 4.5 12C4.5 12.34 4.53 12.66 4.57 12.98L2.46 14.63C2.28 14.77 2.23 15.03 2.32 15.24L4.32 18.76C4.42 18.96 4.64 19.05 4.85 18.99L7.35 18.21C7.87 18.6 8.44 18.92 9.06 19.14L9.5 21.75C9.54 21.97 9.73 22.12 9.95 22.12H14.05C14.27 22.12 14.46 21.97 14.5 21.75L14.94 19.14C15.56 18.92 16.13 18.6 16.65 18.21L19.15 18.99C19.36 19.05 19.58 18.96 19.68 18.76L21.68 15.24C21.77 15.03 21.72 14.77 21.54 14.63L19.43 12.98ZM12 15.5C10.07 15.5 8.5 13.93 8.5 12C8.5 10.07 10.07 8.5 12 8.5C13.93 8.5 15.5 10.07 15.5 12C15.5 13.93 13.93 15.5 12 15.5Z" fill="#273251"/>
        </svg>
        <span class="item__label">Ayarlar</span>
      </div>
      <!-- Admin menü öğesi kaldırıldı -->
    </div>
  </div>
</template>
